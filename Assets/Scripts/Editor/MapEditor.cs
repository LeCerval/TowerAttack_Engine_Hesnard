...
public class MapEditor : Editor
{
    ...
    // Variable EditEdgeMode
    private bool m_IsInEditEdgeMode = false;
    private bool m_DeletingEdge = false;
    private bool m_AddEges = false;
    

    //Variable ShowMapView
    ...
    public override void OnInspectorGUI()
    {
        ...
        m_IsInEditEdgeMode = GUILayout.Toggle(m_IsInEditEdgeMode, "Edge Edit Mode");

        EditorGUI.BeginDisabledGroup(m_IsInEditEdgeMode == false);
        m_DeletingEdge = GUILayout.Toggle(m_DeletingEdge, "Deleting Edge");
        m_AddEges = GUILayout.Toggle(m_AddEges, "Add Edges");
        EditorGUI.EndDisabledGroup();


        GUILayout.Label("   Edit Square  ", EditorStyles.boldLabel);
        m_IsInEditSquareMode = GUILayout.Toggle(m_IsInEditSquareMode, "Square Edit Mode");
        
        
        if(m_IsInEditEdgeMode)
        {
            m_IsInEditSquareMode = false;
            m_IsInEditEdgeMode = true;

        }
        else
        {
            m_IsInEditEdgeMode = false;
            m_IsInEditSquareMode = true;
        }
        ...
        //désactivation du toggle EditEdgeMode
